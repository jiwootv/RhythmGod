...
class Chabo(pygame.sprite.Sprite):
    def __init__(self, type, speed):
        ...
        self.type = type
        # 눌러야 하는 시간
        # FIXME: tlqkf 어떻게 하든 간에 이 코드가 문제야.
        # (타이밍 수정)
        self.note_time = pygame.time.get_ticks() + (460 / speed) * 1000
    ...
    def update(self):
        ...
        if self.moving_down:
            global delta_time
            self.rect.y += self.speed * delta_time/1000  # 스프라이트가 내려가는 속도 조절
...
class Game:
    ...
    def check_collision(self, type):
        for sprite in all_sprites:
            ...
            accuracy = sprite.note_time - pygame.time.get_ticks()
